<template>
  ...
  >
    <el-form
        ...
        class="gs-form"
    >
      <el-row type="flex" class="flex-wrap mb-3">
        <el-col :lg="24">
          <el-form-item
              label="Question type"
              prop="type"
